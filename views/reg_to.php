...
<body>
    ...
    <script src="./views/data_tables/reg_to.js"></script>
    <script src="./views/js/reg_to/add_reg_to.js"></script>
    <script src="./views/js/reg_to/remove_reg_to.js"></script>
    <script src="./views/js/reg_to/edit_reg_to.js"></script>
    <script src="./views/js/reg_to/sent_to_by_change.js"></script>
    <script src="./views/js/reg_to/append_reg_to_sub.js"></script>
    <script src="./views/js/reg_to/add_reg_to_sub.js"></script>
    <script src="./views/js/reg_to/reg_sub_del.js"></script>
    <script src="./views/js/reg_to/easyAutocomplete.js"></script>
