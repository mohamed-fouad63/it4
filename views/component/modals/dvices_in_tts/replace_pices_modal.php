        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control me-3 office_name" id="office_name" placeholder=">اسم المكتب" readonly>
                    <span class="input-group-text  col-sm-2" id="basic-addon1">نوع الجهاز</span>
                    <input type="text" class="form-control dvice_name" id="dvice_name" placeholder="نوع الجهاز" readonly>
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text  col-sm-2" id="basic-addon1">سريال</span>
                    <input type="text" class="form-control me-3 dvice_sn" id="dvice_sn" placeholder="سريال" readonly>
                    <span class="input-group-text  col-sm-2" id="basic-addon1">التاريخ</span>
                    <input type="date" class="form-control" id="date_replace_Pices" value="<?php echo date('Y-m-d') ?>">
                </div>
                <!-- <div class="input-group mb-3">
                ...
                <div class="card flex-grow-1">
                    ...
                    <div class="card-body">
                            <input type="radio" class="btn-check" name="Powersupply" data-pices_id="PowerSupply" value="ATX 24 Pin" id="Power1" autocomplete="off">
                            <label class="btn btn-outline-success" for="Power1">ATX 24 Pin</label>
                    </div>
                </div>
                ...
                <div class="card flex-grow-1">
                    ...
                    <div class="card-body">
                            <input type="radio" class="btn-check" name="Hraddisk" data-pices_id="HradDisk" value="Western Digital 1T" id="Hard1" autocomplete="off">
                            <label class="btn btn-outline-success" for="Hard1">Western Digital 1T</label>

                            <input type="radio" class="btn-check" name="Hraddisk" data-pices_id="HradDisk" value="Crucial  SSD 240GB" id="Hard2" autocomplete="off">
