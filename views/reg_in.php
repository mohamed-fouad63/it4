...
<head>
    ...
    <link rel="stylesheet" href="./views/assets/css/plugins/easy-autocomplete.min.css">
...
<body>
                        ...
                        <fieldset>
                            ...
                            <div id="reg_in_form">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="date" class="form-control col-sm-6  me-3" id="date_reg_in" readonly value="<?php echo date('Y-m-d'); ?>">
                                    <select class="input-group-text" id="send_to_by">
                                        <option value="barcode" selected>بالمسجل</option>
                                        <option value="hand">بيد</option>
                                    </select>
                                    <input type="text" id="czc" placeholder="RR123456789EG" class="form-control col-sm-6 masked" data-charset="__XXXXXXXXX__" style="text-transform:uppercase" autofocus />
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <textarea type="search" class="form-control col-sm-9" id="sub_reg_in" style="height: 110px;"></textarea>

                                </div>
                                <div class="mx-auto w-25">
                                    <button class="btn btn-primary" id="add_reg_in_btn"><i class="bi bi-plus"></i></button>
                                    <button class="btn btn-success" id="edit_reg_in_btn" style="display:none" value=""><i class="bi bi-pencil-square"></i></button>
                                </div>
                            </div>
                        </fieldset>
                    </div>
                        ...
                        <fieldset>
                                ...
                                <span class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <div class="d-flex">
                                            ...
                                            <button class="btn btn-success append_reg_in_sub ms-2"><i class="bi bi-check-lg"></i></button>
                            ...
                            <div class="reg_in_sub_container border border-success">
                                <div class="d-flex align-content-start flex-wrap pt-1">
                                    <?php
                                    $reg_in_sub_json = './views/jsons/' . $_SESSION['db'] . '/';
    ...
    <script src="./views/data_tables/reg_in.js"></script>
    <script src="./views/js/reg_in/add_reg_in.js"></script>
    <script src="./views/js/reg_in/remove_reg_in.js"></script>
    <script src="./views/js/reg_in/edit_reg_in.js"></script>
    <script src="./views/js/reg_in/append_reg_in_sub.js"></script>
    <script src="./views/js/reg_in/reg_sub_del.js"></script>
    <script src="./views/js/reg_in/add_reg_in_sub.js"></script>
    <script src="./views/js/reg_in/sent_in_by_change.js"></script>
    <script src="./views/js/reg_in/easyAutocomplete.js"></script>
